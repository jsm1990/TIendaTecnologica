...
(
	...
	DIR_PROVINCIA	  VARCHAR(20)   DEFAULT('')	    NOT NULL,       
    DIR_CANTON		  VARCHAR(50)   DEFAULT('')	    NOT NULL, 
    DIR_DISTRITO	  VARCHAR(50)	DEFAULT('')	    NOT NULL,  
	DIR_DIRECCION	  VARCHAR(200)	DEFAULT('')	    NOT NULL,  
 	DIR_USU_ID		  INTEGER	DEFAULT('')	    NOT NULL,  
	--LLAVE PRIMARIA 
    CONSTRAINT PK_DIRECCIONES PRIMARY KEY CLUSTERED (DIR_ID)      
)
GO

ALTER TABLE DIRECCION ADD CONSTRAINT FK_DIR
    FOREIGN KEY(DIR_USU_ID)
